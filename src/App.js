...
class App extends Component {
  ...
  onClick = (id) => {
    console.log("clicked");
    console.log(id.target.getAttribute("alt"));
    ...
    if (this.state.images.indexOf(id) === -1) {
      ...
      this.state.images[id.target.getAttribute("alt")].count = 1;
      ...
      console.log(this.state.images[id.target.getAttribute("alt")].count);
